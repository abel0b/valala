...
impl Hex {
    pub fn new(display: &glium::Display, q: i32, r: i32, s: i32) -> Hex {
        let center = (
        ...
        let vertices: [Vertex; 13] = [
            ...
            Vertex { position: Self::corner(&center, 0, 0.0), tex_coords: (0.0, 0.5) },
            Vertex { position: Self::corner(&center, 1, 0.0), tex_coords: (0.3333333, 0.0) },
            Vertex { position: Self::corner(&center, 2, 0.0), tex_coords: (0.6666666, 0.0) },
            Vertex { position: Self::corner(&center, 3, 0.0), tex_coords: (1.0, 0.5) },
            Vertex { position: Self::corner(&center, 4, 0.0), tex_coords: (0.6666666, 1.0) },
            Vertex { position: Self::corner(&center, 5, 0.0), tex_coords: (0.3333333, 1.0) },
            Vertex { position: Self::corner(&center, 0, -2.0), tex_coords: (0.0, 0.5) },
            Vertex { position: Self::corner(&center, 1, -2.0), tex_coords: (0.3333333, 0.0) },
            Vertex { position: Self::corner(&center, 2, -2.0), tex_coords: (0.6666666, 0.0) },
            Vertex { position: Self::corner(&center, 3, -2.0), tex_coords: (1.0, 0.5) },
            Vertex { position: Self::corner(&center, 4, -2.0), tex_coords: (0.6666666, 1.0) },
            Vertex { position: Self::corner(&center, 5, -2.0), tex_coords: (0.3333333, 1.0) },
       ];
